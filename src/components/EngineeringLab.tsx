...
import { engineeringExperiments } from '../data/experiments';
...
export default function EngineeringLab({ completedExperiments, onCompleteExperiment }: EngineeringLabProps) {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#9a6bff]/20 rounded-2xl mb-4">
            <Cpu className="w-8 h-8 text-[#9a6bff]" />
          </div>
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Build circuits, create motors, and discover the principles of electrical and mechanical engineering through hands-on projects.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {engineeringExperiments.map((experiment) => (
            <ExperimentCard
              key={experiment.id}
